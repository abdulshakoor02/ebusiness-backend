    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ports.CreateCountryRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ports.UpdateCountryRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/lead-categories": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create Lead Category Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/lead-categories/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update Lead Category Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/lead-sources": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create Lead Source Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/lead-sources/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update Lead Source Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/leads/{id}/status": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update Lead Status Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ports.UpdateLeadStatusRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/leads/{lead_id}/appointments": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Create Lead Appointment Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/leads/{lead_id}/appointments/list": {
            "post": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/leads/{lead_id}/appointments/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update Lead Appointment Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/leads/{lead_id}/comments": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Create Lead Comment Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/leads/{lead_id}/comments/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update Lead Comment Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/permissions": {
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "Remove Permission Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/permissions/roles/inherit": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Assign Role Inheritance Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ports.CreateQualificationRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ports.UpdateQualificationRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "ports.CreateLeadAppointmentRequest": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "using string representation for JSON decoding convenience",
                    "type": "string"
                },
                "title": {
                    "type": "string"
        ...
        "ports.CreateQualificationRequest": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
        ...
        "ports.RolePermission": {
            ...
            "properties": {
                ...
                "filter_field": {
                    "description": "e.g., \"assigned_to\", \"created_by\"",
                    "type": "string"
                },
                "id": {
                    "type": "string"
        ...
        "ports.UpdateQualificationRequest": {
            "type": "object",
            "properties": {
                "is_active": {
                    "type": "boolean"
